"""
CategoricalVariables_ParettoChart.py
...
ax1.bar(sales_data['Car Company'], sales_data['Frequency'], label='Sales in Bonn', color=cmap(1))
ax1.set_ylim(bottom=0, top=150)
plt.title('Sales in Bonn')
plt.xlabel('Car Company')
plt.ylabel('Frequency')
ax2 = ax1.twinx()
ax2.plot(sales_data['Car Company'], sales_data['Cumulative Frequency'], color=cmap(2), marker='D')
