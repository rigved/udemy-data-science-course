"""
ConfidenceIntervals_TwoMeansIndependentSamples_VariancesUnknownAssumedEqual.py
...
data = pd.read_excel('data/ConfidenceIntervals_TwoMeansIndependentSamples_VariancesUnknownAssumedEqual.xlsx', sheet_name='CI, indep, var unkwn', skiprows=list(range(3)), usecols='B:C')
...
print('t-score for 95% confidence and {} degrees of freedom: {:.2f}'.format(df, t_score))
print('Confidence Interval with 95% confidence and {} degrees of freedom: ({:.2f}, {:.2f})'.format(df, (mean_1 - mean_2) - (t_score * std_err), (mean_1 - mean_2) + (t_score * std_err)))
